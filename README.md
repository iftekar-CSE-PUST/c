    ...
    <style>
        * {
        ...
        @keyframes float {
            ...
            50% { transform: translate(30px, -30px) rotate(180deg) scale(1.05); }
        }
        ...
        .header-text h2 {
            font-size: 1.3em;
            background: linear-gradient(135deg, #ff6b6b, #f093fb, #667eea);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            background-clip: text;
            margin-bottom: 4px;
...
<body>
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="container">
            ...
            <footer>
                <p>&copy; <span id="year"></span> Pabna University of Science & Technology</p>
                <div class="footer-divider"></div>
                <p>Computer Science & Engineering Department</p>
                <div class="footer-links">
                    <a href="#" id="privacyLink"><i class="fas fa-shield-alt"></i> Privacy</a>
                    <a href="#" id="termsLink"><i class="fas fa-file-contract"></i> Terms</a>
            ...
            <div class="announcement-content">
                ...
                <div class="announcement-modal-body">
                    <div class="announcement-info-box">
                        ...
                        <p><strong>Note:</strong> Semester Final Examination will start from 6th January, 2026.</p>
                    </div>
                    <div class="announcement-image-container">
                        <img src="https://i.ibb.co.com/BFKW8fv/att-ma-FUVD93-AMe-W-x51z8xkz-EA0-MPd-Z-OLBLh2-H2fy-R-A.jpg"
                            alt="Exam Schedule" class="announcement-image">
                    </div>
                    <div class="announcement-notice">
                        <p><strong>Important:</strong> All exams at CSE Department. Bring ID & admit cards. Mobile phones prohibited.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="privacy-modal-body">
                    <div class="policy-section">
                        ...
                        <ul>
                            ...
                            <li>Session data stored locally</li>
                    ...
                    <div class="policy-section">
                        <h4>Data Usage</h4>
                        <ul>
                            <li>Credentials for authentication only</li>
                            <li>Session data stored in browser</li>
            ...
            <div class="terms-content">
                ...
                <div class="terms-modal-body">
                    <div class="policy-section">
                        ...
                        <ul>
                            <li>Current CSE students (Batch 17th)</li>
                            <li>Authorized faculty and staff</li>
                            <li>Academic purposes only</li>
                        </ul>
                    </div>
                    <div class="policy-section">
                ...
                <div class="contact-modal-body">
                    <div class="contact-info">
                        ...
                        <div class="contact-item">
                            ...
                            <h4>Email</h4>
                            <p><a href="mailto:riadraj009@gmail.com">riadraj009@gmail.com</a></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        const validUsers = [
            { 
                username: 'cse17', 
                password: 'cHJpbWUxNw==', // Base64 encoded "prime17"
        ...
        const students = [
            ...
            {id : 21, name : "Zahin Mahmud Daiyan", studentId : "250123", currentAddress : "Mahtab Tower, Pabna", permanentAddress : "Mohonpur, Natore", phone : "01701299258", facebook : "https://www.facebook.com/zahin.mahmud.daiyan.CSE.PUST", email : "zahinmahmuddaiyan271@gmail.com", bloodGroup : "O+", photo : "https://i.ibb.co.com/hRX7T65C/IMG-3538.jpg"},
            { id: 22, name: "Mst. Khandakar Jahida", studentId: "250124", currentAddress: "Munsurabad, Pabna", permanentAddress: "Polastoli, Tangail", phone: "01303341680", facebook: "https://www.facebook.com/share/1FBAjWHw1W/", email: "mstkhandakerjahida@gmail", bloodGroup: "O+", photo: "https://i.ibb.co.com/5xS6Gy7J/IMG-3587.jpg"},
